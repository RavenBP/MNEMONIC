...
UCLASS(config=Game)
class AMNEMONIC_ProjectCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AMNEMONIC_ProjectProjectile> ProjectileClass;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Gate Strikes")
